...
namespace TRINAX.Utils {
    ...
    public class JsonFileUtility {
        ...
        public static void DeleteJsonFile(string path, JSONSTATE state) {
            if (state == JSONSTATE.RESOURCE) path = Application.dataPath + "/" + "Resources/" + path;
            else if (state == JSONSTATE.PERSISTENT_DATA_PATH) path = Application.persistentDataPath + "/" + path;
            else if (state == JSONSTATE.GAME_DATA_PATH) path = Application.dataPath + "/" + path;
